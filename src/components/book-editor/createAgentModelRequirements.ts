import { parseAgentSource } from '../../../book-agent-source/parseAgentSource';
import { string_agent_source } from '../../../book-agent-source/string_agent_source';
import {
 ...
 * @param agentSource The agent source string that may contain PROFILE IMAGE line
